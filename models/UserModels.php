...
class UserModels extends Model {
	public function set( $user_data = array() ) {
		...
		$this->query = "REPLACE INTO tusuarioscentrocomputo
			(codUsuario,contrasena,rangoUsuario)
	...
	public function validate_user($codUsuario, $contrasena) {
		$this->query = "SELECT * FROM tusuarioscentrocomputo WHERE codUsuario = '$codUsuario' AND contrasena ='$contrasena'";
		$this->get_query();
